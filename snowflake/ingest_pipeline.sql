    ...
    session.sql('''
        ...
        signals AS (
            SELECT
                ...
                -- The 's' flag is load-bearing: REGEXP_LIKE anchors at both ends and '.'
                -- does not cross a newline, so without it '.*x.*' can never match a
                -- subject joined to a body. Every AI flag came back false.
                REGEXP_LIKE(
